export const phoneAreaList = [
  ...
  { value: "+670", label: "East Timor (Timor-Leste)" },
  ...
  { value: "+268", label: "Eswatini (Swaziland)" },
  ...
  { value: "+225", label: "Ivory Coast (Côte d'Ivoire)" },
  ...
  // { value: '+850', label: 'Korea, Democratic People\'s Republic of (North Korea)' },
  ...
  { value: "+590", label: "Saint Martin (French part)" },
  ...
  { value: "+1-721", label: "Sint Maarten (Dutch part)" },
